...
const contractABI = [{"constant": true,"inputs": [{"name": "_owner", "type": "address"}],"name": "balanceOf","outputs": [{"name": "balance", "type": "uint256"}],"type": "function"}];
...
const HouseStaking = new web3.eth.Contract(houseABI, '0x2eF9d702c42BC0F8B9D7305C34B4f63526502255');
const Ambassador_V03 = new web3.eth.Contract(Ambassador_V03_ABI, '0x467eF538C90434D4F69cF8A8F40cd71a96e8424e');
    
CMJ_inUSDT = parseFloat(document.getElementById("priceD2").textContent) || 0;
JTAO_inUSDT = parseFloat(document.getElementById("priceD22").textContent) || 0;
    ...
    document.addEventListener("DOMContentLoaded", function() {
      var allCards = document.querySelectorAll('#factory,#dungeon,#gashapon, #pool, #upgrade, #noti, #logs,#walletWatcher,#kyc');
    ...
    function toggleCards(showType) {
      ...
      var allCards = document.querySelectorAll('#priceBoard,#factory, #dungeon, #gashapon, #pool, #upgrade, #noti, #logs,#walletWatcher,#kyc');
      for (var i = 0; i < allCards.length; i++) {
        allCards[i].style.display = 'none';
      }
 ...
 function calculateProfit() {
  ...
  function displayPNLMessages(OSPower,HouseSTaking_inJBC,HouseStakingGasFee,CuPower,JaspPower,AngbPower,EEPower,CrypticCog_JTAO,CrypticCogsGasFee,CrypticCog_inJBC,copperMineGasFee, jasperCaveGasFee, copperMiner2GasFee, copperMineGasFee_inJBC, copperMiner2GasFee_inJBC, jasperCaveGasFee_inJBC, daemonWorldGasFee, daemonWorldGasFee_inJBC) {
    ...
    for (let i = 0; i < regisCount; i++) {
      // Fetching data within the loop and immediately adding it to the table
  ...
  loadKycData();
    ...
    async function main() {
            ...
            exchangeRate = parseFloat(document.getElementById("usdTHB").textContent) || 33; 
            // Buy Token
            if(CMJ_to_JBC != 0 && CMJ_inJUST != 0){
                document.getElementById("priceB2").innerHTML = (CMJ_to_JBC*1.013).toLocaleString(undefined,{maximumFractionDigits:4});
                document.getElementById("priceD2").innerHTML = (CMJ_inJUST*1.013).toLocaleString(undefined,{maximumFractionDigits:4});  // CMJ_to_JUSDT
                document.getElementById("CMJ_buyTHB").innerHTML = (CMJ_inJUST*1.013*exchangeRate).toLocaleString(undefined,{maximumFractionDigits:4});  // CMJ_to_THB
                // Sell Token
                document.getElementById("Sell_CMJinJBC").innerHTML = (CMJ_to_JBC*0.99).toLocaleString(undefined,{maximumFractionDigits:4});
                document.getElementById("Sell_CMJinUSD").innerHTML = (CMJ_inJUST*0.99).toLocaleString(undefined,{maximumFractionDigits:4});  // CMJ_to_JUSDT
                document.getElementById("CMJ_sellTHB").innerHTML = (CMJ_inJUST*exchangeRate*0.99).toLocaleString(undefined,{maximumFractionDigits:4});  // CMJ_to_THB
            }
            if(JBC_to_CMJ !=0 && JBC_inJUST !=0){
            document.getElementById("priceB3").innerHTML = (JBC_to_CMJ*1.013).toLocaleString(undefined,{maximumFractionDigits:4});
            document.getElementById("priceD3").innerHTML = (JBC_inJUST*1.013).toLocaleString(undefined,{maximumFractionDigits:4});
            document.getElementById("JBC_buyTHB").innerHTML = (JBC_inJUST*exchangeRate*1.013).toLocaleString(undefined,{maximumFractionDigits:4});
 
            document.getElementById("Sell_JBCinCMJ").innerHTML = (JBC_to_CMJ*0.99).toLocaleString(undefined,{maximumFractionDigits:4});
            document.getElementById("Sell_JBCinUSD").innerHTML = (JBC_inJUST*0.99).toLocaleString(undefined,{maximumFractionDigits:4});
            document.getElementById("JBC_sellTHB").innerHTML = (JBC_inJUST*exchangeRate*0.99).toLocaleString(undefined,{maximumFractionDigits:4});
            }
            if(CMJ_to_Meowmes != 0 && Meow_inJUST != 0){
    
            document.getElementById("priceB14").innerHTML = (CMJ_to_Meowmes*1.05).toLocaleString(undefined,{maximumFractionDigits:5});
            document.getElementById("priceD14").innerHTML = (Meow_inJUST*1.05).toLocaleString(undefined,{maximumFractionDigits:5});
            document.getElementById("MEOW_buyTHB").innerHTML = (Meow_inJUST*exchangeRate*1.05).toLocaleString(undefined,{maximumFractionDigits:5});
 
            document.getElementById("Sell_MeowinCMJ").innerHTML = (CMJ_to_Meowmes*0.95).toLocaleString(undefined,{maximumFractionDigits:5});
            document.getElementById("Sell_MeowinUSD").innerHTML = (Meow_inJUST*0.95).toLocaleString(undefined,{maximumFractionDigits:5});
            document.getElementById("MEOW_sellTHB").innerHTML = (Meow_inJUST*exchangeRate*0.95).toLocaleString(undefined,{maximumFractionDigits:5});
            }
            ...
            if (CMJ_to_BBQ != 0){
              document.getElementById("priceB8").innerHTML = (CMJ_to_BBQ*1.05).toLocaleString(undefined,{maximumFractionDigits:10});
              document.getElementById("priceB8_2").innerHTML = (CMJ_to_BBQ*0.95).toLocaleString(undefined,{maximumFractionDigits:10});
            }
            ...
            if (Cu_inCuCMJ != 0 && CMJ_inCuCMJ != 0){
              document.getElementById("priceB7").innerHTML = (CMJ_to_Cu*1.05).toLocaleString(undefined,{maximumFractionDigits:10});
              document.getElementById("Sell_CuinCMJ").innerHTML = (CMJ_to_Cu*0.95).toLocaleString(undefined,{maximumFractionDigits:10});
            }
            ...
            if (CMJ_to_Jasp != 0){
              document.getElementById("priceB17").innerHTML = (CMJ_to_Jasp*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB17_2").innerHTML = (CMJ_to_Jasp*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            ...
            const CMJ_to_Jdao = (CMJ_inJdaoCMJ/Jdao_inJdaoCMJ).toFixed(10);
                    // display 
            if(CMJ_to_Jdao != 0){
              document.getElementById("priceB15").innerHTML = (CMJ_to_Jdao*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB15_2").innerHTML = (CMJ_to_Jdao*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            ...
            if(CMJ_to_Pza != 0){
              document.getElementById("priceB9").innerHTML = (CMJ_to_Pza*1.05).toLocaleString(undefined,{maximumFractionDigits:8});
              document.getElementById("priceB9_2").innerHTML = (CMJ_to_Pza*0.95).toLocaleString(undefined,{maximumFractionDigits:8});
            }
            ...
            if(CMJ_to_Sx31 != 0){
              document.getElementById("priceB11").innerHTML = (CMJ_to_Sx31*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB11_2").innerHTML = (CMJ_to_Sx31*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            ...
            if(CMJ_to_Ctuna != 0){
              document.getElementById("priceB10").innerHTML = (CMJ_to_Ctuna*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB10_2").innerHTML = (CMJ_to_Ctuna*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            ...
            if(CMJ_to_Gold != 0){
              document.getElementById("priceB13").innerHTML = (CMJ_to_Gold*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB13_2").innerHTML = (CMJ_to_Gold*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            ...
            if(CMJ_to_Os != 0){
              document.getElementById("priceB18").innerHTML = (CMJ_to_Os*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB18_2").innerHTML = (CMJ_to_Os*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            ...
            if(SWAR_in_CMJ != 0){
              document.getElementById("priceB21").innerHTML = (SWAR_in_CMJ*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceD21").innerHTML = (WJBC_to_Swar*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB21_2").innerHTML = (SWAR_in_CMJ*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceD21_2").innerHTML = (WJBC_to_Swar*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            ...
            if(ANGB_in_CMJ != 0){
              document.getElementById("priceB23").innerHTML = (ANGB_in_CMJ*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceD23").innerHTML = (WJBC_to_ANGB*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB23_2").innerHTML = (ANGB_in_CMJ*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceD23_2").innerHTML = (WJBC_to_ANGB*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            ...
            if(CMJ_to_SIL != 0){
              document.getElementById("priceB12").innerHTML = (CMJ_to_SIL*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("priceB12_2").innerHTML = (CMJ_to_SIL*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            // Bal of CMJ , PLAT 
            address = '0x78Ff63F4f91Ce56f72882ef9dbE3Be79fBF15044';
            const Plat_inPlatCMJ = await call_SC(address, Plat, 18);
            const CMJ_inPlatCMJ = await call_SC(address, CMJ, 18);
            const Plat_to_CMJ = (Plat_inPlatCMJ/CMJ_inPlatCMJ).toFixed(6);
            const CMJ_to_Plat = (CMJ_inPlatCMJ/Plat_inPlatCMJ).toFixed(10);
            if(CMJ_to_Plat != 0){
            ...
            if(Tao_CMJ != 0){
            document.getElementById('priceB22').innerText = `${Tao_CMJ.toFixed(4)}`;
          }
            ...
            if(JTAO_to_II != 0){
              document.getElementById("IIPrice_JTAO").innerHTML = (JTAO_to_II*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
            document.getElementById("IIPrice_JTAO_2").innerHTML = (JTAO_to_II*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            JTAO_to_CMJ = (JTAO_to_II*JTAO_inUSDT)/CMJ_inUSDT2;
            II_to_CMJ = ((JTAO_to_II*JTAO_inUSDT)/CMJ_inUSDT2).toFixed(8)
            if(II_to_CMJ != 0){
              document.getElementById("IIPrice_CMJ").innerHTML = (II_to_CMJ*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("IIPrice_CMJ_2").innerHTML = (II_to_CMJ*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
            ...
            const JTAO_to_EE = (JTAO_inEEJTAO/EE_inEEJTAO).toLocaleString(undefined,{maximumFractionDigits:4});
                console.log("EE-JTAO | ",EE_inEEJTAO.toFixed(4),"EE , ",JTAO_inEEJTAO.toFixed(4)," JTAO (",JTAO_to_EE," EE/JTAO)")
            JTAO_inUSDT = parseFloat(document.getElementById("priceD22").textContent) || 0;
            CMJ_inUSDT2 = parseFloat(document.getElementById("priceD2").textContent) || 0;
            if(JTAO_to_EE != 0){
              document.getElementById("EEPrice_JTAO").innerHTML = (JTAO_to_EE*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("EEPrice_JTAO_2").innerHTML = (JTAO_to_EE*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
            }
                      
            JTAO_to_CMJ = (JTAO_to_EE*JTAO_inUSDT)/CMJ_inUSDT2;
            EEPrice_CMJ = ((JTAO_to_EE*JTAO_inUSDT)/CMJ_inUSDT2).toFixed(8)
            if(EEPrice_CMJ != 0){
              document.getElementById("EEPrice_CMJ").innerHTML = (EEPrice_CMJ*1.05).toLocaleString(undefined,{maximumFractionDigits:6});
              document.getElementById("EEPrice_CMJ_2").innerHTML = (EEPrice_CMJ*0.95).toLocaleString(undefined,{maximumFractionDigits:6});
    ...
    .then(data => {
        ...
        pools.forEach(pool => {
            if (pool.id === 'bitkub_chain_0x0969c9d1786c8e570f5955eed7acb4c6aebe2c08') {
                ...
                exchangeRate = parseFloat(document.getElementById("usdTHB").textContent) || 33; 
                document.getElementById('priceD22').innerText = `${TaoPrice.toFixed(6)}`;
                document.getElementById('TAO_buyTHB').innerText = `${setLocal((exchangeRate*TaoPrice),4)}`
            }
        });
    })
